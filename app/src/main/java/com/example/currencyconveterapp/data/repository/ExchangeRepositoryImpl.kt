...
class ExchangeRepositoryImpl(
    ...
    private val API_KEY = "eedbc4873cc70dec8e2c4ffa"
    override suspend fun convert(fromCurrency: String, toCurrency: String, amount: Double): Double {
        return try {
            val result = exchangeApiService.convert(apiKey = API_KEY, fromCurrency = fromCurrency, toCurrency = toCurrency,amount=amount)
            println("$TAG Result is: ${result.conversion_result}")
